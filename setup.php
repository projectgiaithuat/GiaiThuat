...
<?php
	...
	// tạo bảng hoc sinh
	$db_table = "hoc_sinh";
	$db_query = "CREATE TABLE IF NOT EXISTS ".$db_table."(id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, ten_hs VARCHAR(255) NOT NULL UNIQUE, chieu_cao INT NOT NULL, do_can INT NOT NULL) ENGINE = InnoDB;";
	mysqli_query($db_connect, $db_query) or die("create table error1");
	//tạo bảng giao vien
	$db_table_2 = "giao_vien";
	$db_query= "CREATE TABLE IF NOT EXISTS ".$db_table_2."(id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, user_name VARCHAR(255) NOT NULL , password VARCHAR(255) NOT NULL) ENGINE = InnoDB;";
